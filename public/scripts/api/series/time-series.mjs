import { DailyAggregates } from "./daily-aggregates.mjs"
...
export class Series {
	 ...
	 * @param {string} [period] - The period for regular series (optional)
	 */
	 ...
	 */
	static irregular() { return new Series("irregular") }
}

export const COL_TS = 0
...
export class Column {
	...
	constructor(name, quantifiable, unit, symbol = "") {
		...
		this.aggregates = new DailyAggregates()
	}
	...
	recalculateAggregates(val, ts) {
		this.aggregates.process(val, ts)
	}
}
